...
- アーカイブ配信
従来のカンファレンスでオンライン配信があるところは稀でした。主催者の記録用などとして映像を残す場合もありましたが、基本的に外に出るものではありませんでした。したがって、聴講するためには現地に行く必要があり、あとから再度見るといったことはできませんでした。ところが昨今のカンファレンスでは、登壇者もリモートで登壇する、それをZoomやYouTube等で配信する形が増え、少しの手間でアーカイブ配信することができるようになりました。その結果、様々なカンファレンスでアーカイブ配信がされるようになっています。

全セッションが完全にオープンなカンファレンス、登壇者の了承が取れている一部を公開しているカンファレンス、参加者だけに限定公開しているカンファレンスなど、アーカイブ配信の思想や扱いは様々ですが、並列トラックをあとから見たり、再度見て学びを深めるなどが可能です。
